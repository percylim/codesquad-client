...
//    return false;
   // *****************************
    Axios
      .post(url + '/api/salesReturnNote', data
...
// return false;
    ...
    Axios
      .post(url + '/api/purchaseVoucher', voucherData
  ...
  const onSearchInvoice = async () => {
    ...
    Axios
      .get(url + `/api/salesInvoiceVerify`,
        {
          params: {
            companyID: companyID,
            supplierID: supplierID,
    ...
    Axios
      .get(url + `/api/salesInvoiceDetail`,
        {
          params: {
            companyID: companyID,
            supplierID: supplierID,
...
/>
        ...
        <p></p>
        <td></td>
        <td><button className = "fa fa-print" style={{ backgroundColor: "green", color: "white", width: '250px' }} onClick={() => onPrintNote()}>Print Sales Return Note</button></td>
        <td><button className = "fa fa-book" style={{ backgroundColor: "blue", color: "white", width: '200px' }} onClick={() => onNew()}>New Return Note </button></td>
        <td><button className = 'fa fa-home' style={{ backgroundColor: "grey", color: "black", width: '100px' }} onClick={() => handleHome()}>Home</button></td>
        <td><button className = "fa fa-plus" style={buttonStyle} type="button" onClick={onAddReturnNote}>Add Return Item </button> </td>
        ...
        <div>
          ...
          <label style={{ paddingLeft: '10px' }}>
            ...
            <td><button className = "fa fa-save" style={{ backgroundColor: "red", color: "white", width: '400px' }} onClick={() => onSave(voucherData, totalDrAmt, totalCrAmt)}>Save Return Note and Voucher</button></td>
            <td><button className = "fa fa-plus" style={{ backgroundColor: "cyan", color: "black", width: '200px' }} onClick={() => onAddVoucher()}>Add Voucher Item</button></td>
