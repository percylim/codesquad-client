  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <DropdownSubmenu href="#action/3.7" title="Utilities">
     ...
     <NavDropdown.Item href="userProfile">Add / Edit / Delete User</NavDropdown.Item>
      ...
      <NavDropdown.Item href="monthlyTrialBalance">Monthly Trail Balance</NavDropdown.Item> 
      <NavDropdown.Item href="monthlyProfitAndLoss">Monthly Profit And Loss Statement</NavDropdown.Item>
      <NavDropdown.Item href="monthlyBalanceSheet">Monthly Balance Sheet</NavDropdown.Item>
      <NavDropdown.Divider /> 
<DropdownSubmenu title="Previous Year Financial Report" className="dropdown-submenu">
