      ...
      let newDataTOY = {
       ...
       date_close: '',
        ...
        const user = {  companyID: companyID, year: year};
          ...
          Axios
          .post(url + '/api/profitAndLossDelete', user  )
          .then(res => {
          }, []);

          Axios
          .post(url + '/api/incomeSummaryDelete', user  )
          .then(res => {

            Axios
            .post(url + '/api/incomeSummary', incData
            ).then(res => {
              if (res.data === 'Success') {
...
//alert(PNLData[0].glName);
      Axios
      .post(url + '/api/profitAndLossUpdate', PNLData
      ).then(res => {
        if (res.data === 'Success') {
...
Axios
.get(url + `/api/loadTaxComputation`,
  {
    params: {
    companyID: companyID,
    profit: amount,
