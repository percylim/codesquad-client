    ...
    render() {
      ...
      return (
        ...
        <form style={mystyle} onSubmit={this.handleSubmit}>
          ...
          Company Register ID :
          <input type="text" style={{marginLeft: "16px"}}maxLength={50} ref={this.companyIDEl} name="companyname" required/>
          </label>
          <label style={{color: 'white', paddingLeft: '0px'}}>Company Admin Name :
          <input type="text" maxLength={50} ref={this.adminNameEl} name="adminname" required/>
          </label>
           <label style={{color: 'white', paddingLeft: '0px'}}> Admin Password :
           <input type="password" style={{marginLeft: "58px"}} name="password" ref={this.passwordEl} required />
           </label>
           </fieldset>
