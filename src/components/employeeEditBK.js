...
.then(res => {
  ...
  this.raceEl.current.value = employee[0].race; 
   ...
   // alert(this.salaryEl.current.value);
  //  alert(employee[0].salary);
      ...
      return (
        ...
        <form style={mystyle} onSubmit={this.handleSubmit}>
         ...
         <label>Date of Birth : 
          ...
          <input type="text" maxLength={20} ref={this.raceEl} name="race"  />
          ...
          <td>      
            ...
            <td>
             ...
             <td>  
             <input type="radio" value="O" name="marital" onChange={this.handleChangeMarried} ref={this.maritalStatusEl} checked={this.state.marital === 'O'}/> Other
          ...
          <label>Salary : 
          <input type="number" maxLength={2} ref={this.childsEl} defaultValue='0' placeholder='0.00' name="childs" />
          </label>
