...
var ID = localStorage.getItem('epfID');
var socsoData = [];
//var userLevel = localStorage.getItem('userLevel');
// const companyName = localStorage.getItem('companyName')
// var eDate = '';
//  var sDate = '';
class SocsoEdit extends React.Component {
    constructor(props) {
      super(props);
   ...
   //   alert(customerData[0].supplierID);
      this.startSalaryEl.current.value = socsoData[0].startSalary;
      this.endSalaryEl.current.value = socsoData[0].endSalary;
      this.companyRateEl.current.value = socsoData[0].companyRate;
      this.employeeRateEl.current.value = socsoData[0].employeeRate;
      this.remarkEl.current.value = socsoData[0].remark;
         ...
         lastSix = text.substr(text.length - 7); // => "Tabs1"
          ...
          // alert(lastSix);
           ...
           if (lastSix === 'Success') {
            ...
            window.location.href='socsoList';
   ...
   const subStyle = {
      ...
      return (
        ...
        <fieldset>
         ...
         <h1>Edit SOCSO Rate Maintenance</h1>
        ...
        <input type="text" maxLength={100} ref={this.remarkEl} name="remark"  />
           ...
           <button style={subStyle} onClick={event =>  window.location.href='socsoList'} >Back</button>
           </p>
