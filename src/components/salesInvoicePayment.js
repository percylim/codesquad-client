...
*/
    ...
    Axios
      ...
      Axios
      .get(url+`/api/salesReceiptVerify`,
        {
         params: {
                 companyID: companyID,
                 receiptNo: receiptNo,
    ...
    Axios
      .post(url + '/api/salesPayment', data
...
<ReactTooltip id="payParticularTip" place="top" effect="solid">
        ...
        <p></p>
        <td></td>
        <td><button class = "fa fa-plus" style={{ backgroundColor: "blue", color: "white", width: '200px' }} onClick={() => onNew()}>New Receipt </button></td>
        <td><button class = "fa fa-home" style={{ backgroundColor: "grey", color: "black", width: '100px' }} onClick={() => handleHome()}>Home</button></td>
        <td><button class = "fa fa-print" style={{ backgroundColor: "green", color: "white", width: '200px' }} onClick={() => onPrintPayment(data)}>Print Receipt</button></td>
        <td><button class = "fa fa-save" style={buttonStyle} type="button" onClick={onAddPayment}>Update Receipt</button> </td>
...
<ReactTooltip id="creditTip" place="top" effect="solid">
  Enter amount to credit
            ...
            <td><button className = "fa fa-save" style={{ backgroundColor: "red", color: "white", width: '300px' }} onClick={() => onSave(voucherData, totalDrAmt, totalCrAmt)}>Save Receipt and Voucher</button></td>
