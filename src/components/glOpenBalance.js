...
function glOpenBalance() {
 ...
 // alert(curPage);
  ...
  const columns = [
    ...
    { dataField: 'glNo', text: 'G/L No.', sort: false ,  headerStyle: { backgroundColor: 'cyan', width: '60px' }, style: { backgroundColor: 'lightgrey'}},
    { dataField: 'glSub', text: 'G/L Sub', sort: false, headerStyle: { backgroundColor: '#BCAAA4', width: '60px' } },
    { dataField: 'glType', text: 'G/L Type', sort: false,   headerStyle: { backgroundColor: 'cyan', width: '65px' }, style: { backgroundColor: 'lightgrey'} },
...
const logstyle = {
  ...
  return (
    <div className="App">
    <div className="row" style={{ 'margin': "10px", 'paddingLeft': "250px" }}>
    <div className="col-sm-10 btn btn-primary">
