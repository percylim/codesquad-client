...
// var eDate = '';
//  var sDate = '';
class EpfEdit extends React.Component {
    constructor(props) {
      super(props);
 ...
 // alert(typeof epfData[0].startSalary);    //   alert(customerData[0].supplierID);
      this.startSalaryEl.current.value = Number(epfData[0].startSalary).toFixed(2);
      this.endSalaryEl.current.value = Number(epfData[0].endSalary).toFixed(2);
      this.companyRateEl.current.value = Number(epfData[0].companyRate).toFixed(2);
      this.employeeRateEl.current.value = Number(epfData[0].employeeRate).toFixed(2);
      this.remarkEl.current.value = epfData[0].remark;
