      ...
      return (
        ...
        <form style={mystyle} onSubmit={this.handleSubmit}>
          <fieldset>
           ...
           <h1>Edit Goods And Services Tax (GST) Profile</h1>
...
>
  ...
  Update
           ...
           <button  style={subStyle} onClick={event =>  window.location.href='gstProfile'} >
           <i class="fa fa-backward" style = {{color: 'white' }}></i>
           Back</button>
           </p>
