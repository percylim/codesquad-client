...
// Add Purchase Item ******************************
 ...
 // alert(catNo);
      ...
      Axios
      .get(url+`/api/productListByCategory`,
        {
         params: {
                 companyID: companyID,
                 categoryID: catNo,
...
Axios
.get(url+`/api/purchaseInvoiceVerify`,
  {
   params: {
           companyID: companyID,
           supplierID: supplierID,
...
<p></p>
           ...
           <td><button style={{backgroundColor: "red", color: "white", width: '300px'}} onClick={() => onSave(voucherData, totalDrAmt, totalCrAmt)}>
