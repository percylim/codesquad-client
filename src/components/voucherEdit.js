        ...
        <div>
            ...
            <table class="table">
                ...
                <td><button type="button" style={{backgroundColor: "yellow", color: "black", border: '2px solid black', borderRadius: '14px'}} onClick={() => onPrint(data, totalDrAmt, totalCrAmt)}>
                 <i className="fa fa-print" style={{marginRight: "15px", border: '2px solid black'}}></i>
                Print Voucher
                </button></td>
                <td><button type="submit" style={{backgroundColor: "green", color: "white" , border: '2px solid white', borderRadius: '14px'}} onClick={() => onSave(data, totalDrAmt, totalCrAmt)}>
                <i className="fa fa-save" style={{marginRight: "15px", color: "white", border: '2px solid white'}}></i>
                Update Edited Voucher
                </button></td>
          ...
          <label style={{ paddingLeft: "15px", marginRight: '1rem'}}>G/L Selection
          <select onChange={(e) => handleChangeGl(e)}>
           ...
           />
            ...
            <input
             ...
             <br />
             <br />
             <td><button class= 'btn btn-info ' style={{marginRight: '20px'}} type="button" onClick={() => onCancel()}>
             <i className="fa fa-book" style={{marginRight: "15px", color: "black", border: '2px solid white'}}></i>
             New Voucher</button></td>
            
             <td><button style={buttonStyle} class = 'btn btn-warning ' type="button" onClick={() => onDelete()}>
             <i className="fa fa-trash" style={{marginRight: "15px", color: "white", border: '2px solid white'}}></i>
             Delete This Voucher </button></td>

             <td><button style={{paddingRight: '20px'}} class = 'btn btn-success' type="button" onClick={onAddVoucher}>
             <i className="fa fa-plus" style={{marginRight: "15px", color: "white", border: '2px solid white'}}></i>
