  ...
  <Tooltip
      ...
      > 
           <button type="submit" className='btn-submit'
            ...
            >
           <i class = "fa fa-save" style={{ marginRight: '8px', color: 'white'}}></i>
            Update
           </button>
      ...
      >       
           <button  style={buttonStyle} onClick={onCancel}>
            <i class="fa fa-trash-o" style={{ marginRight: '8px', color: 'black'}}></i>
           Clear
           </button>
      ...
      >    
           ...
           <button  style={subStyle} onClick={event =>  window.location.href='GlList'} >
