...
Axios
.get(url+`/api/purchaseNoteVerify`,
  {
   params: {
           companyID: companyID,
           supplierID: supplierID,
...
Axios
.post(url+'/api/purchaseNote',data
...
const onSearchInvoice = async (e) => {
     ...
     //  alert(e);
      ...
      Axios
      .get(url+`/api/purchaseInvoiceSearch`,
        {
         params: {
                 companyID: companyID,
                 supplierID: supplierID,
...
<td><button className = "fa fa-file" style={{backgroundColor: "green", color: "white", width: '200px'}} onClick={() => handleAddNote()}>Add Dr/Cr Note</button></td>
...
<p></p>
           ...
           <td><button style={{backgroundColor: "red", color: "white", width: '350px'}} onClick={() => onSave(voucherData, totalDrAmt, totalCrAmt)}>
           <i className='fa fa-save' style={{marginRight: '5px'}}></i>
           Save Invoice and Voucher</button></td>
           <td><button style={{backgroundColor: "yellow", color: "black", width: '250px'}} onClick={() => onAddVoucher()}>
