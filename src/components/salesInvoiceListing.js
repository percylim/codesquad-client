...
id="invoiceTxnTip" place="top" effect="solid">
      ...
      <div className="select-container" >
        ...
        <td><button class = "fa fa-print" style={{ backgroundColor: "green", color: "white", width: '250px', marginLeft: '10rem' }} onClick={() => onPrintSalesInvoice()}>Print Sales Invoice </button></td>
        <td><button class = "fa fa-home" style={{ backgroundColor: "grey", color: "white", width: '100px' }} onClick={() => handleHome()}>Home</button></td>
        <td><button class = "fa fa-plus" style={{ backgroundColor: "blue", color: "white", width: '150px', marginLeft: '0rem' }} onClick={() => handleNew()}>New Listing </button></td>
