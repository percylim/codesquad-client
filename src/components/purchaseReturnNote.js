...
lDisable=false;
  ...
  const onSave = async (voucherData, drTotal, crTotal) => {
   ...
   Axios
      .post(url + '/api/purchaseReturnNote', data
...
// return false;
  ...
  const onSearchInvoice = async () => {
    ...
    Axios
      .get(url + `/api/purchaseInvoiceDetail`,
        {
          params: {
            companyID: companyID,
            supplierID: supplierID,
    ...
    <div>
      ...
      <div>
        ...
        <label style={{ paddingLeft: "10px" }} >
          ...
          >
             <i className="fa fa-search" style={{marginRoght: "8px"}}></i>
          </button>
...
/>
        ...
        <div>
          ...
          <label style={{ paddingLeft: '10px' }}>
            ...
            Save Return Note and Voucher</button></td>
      ...
      <div className="row">
        ...
        <table class="table" style={{ paddingTop: '1px', border: '1px solid black' }}>
          ...
          <tbody style={mystyle} >
            ...
            <td></td>
            <button className = 'fa-solid fa-erase' style={{ backgroundColor: 'blue', color: 'white', height: '40px', padding: '1px' }} onClick={() => handleCancelInvoice()}>Clear Invoice Detail</button>
