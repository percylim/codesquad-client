...
// return false;
    Axios
      .post(url + '/api/salesInvoiceEdit', data)
...
//return false;
    ...
    Axios
      .post(url + '/api/voucherChange', voucherData
...
//}
//alert(allowEdit);
      Axios.get(url + '/api/salesInvoiceDetail',
       {
         params: {
           companyID: companyID,
           invoiceNo: invoiceNo,
   ...
   //       setData(res.data);
    ...
    // alert(customerID)
    Axios
    .get(url + `/api/loadInvoiceTransaction`,
    {
      params: {
        companyID: companyID,
        pur_sal: 'S',
...
/>
        ...
        <td><button className = "fa fa-print" style={{ backgroundColor: "green", color: "white", width: '250px', marginLeft: '10rem' }} onClick={() => onPrintSalesInvoice()}>Print Sales Invoice </button></td>
        <td><button className = "fa fa-book" style={{ backgroundColor: "blue", color: "white", width: '250px' }} onClick={() => onNew()}>New Sales Invoice </button></td>
        <td><button className = "fa fa-home" style={{ backgroundColor: "grey", color: "white", width: '100px' }} onClick={() => handleHome()}>Home</button></td>
        <td><button className = "fa fa-plus" tyle={buttonStyle} type="button" onClick={onAddSalesInvoice}>Add Sales Item </button> </td>
        <p></p>
        <p></p>
        <div></div>
     </div>
        ...
        <p></p>
          <label style={{ paddingLeft: '10px' }}>
            ...
            <td><button className = "fa fa-print"style={{ backgroundColor: "green", color: "white", width: '200px', marginLeft: '10rem' }} onClick={() => onPrint(voucherData, totalDrAmt, totalCrAmt)}>Print Voucher</button></td>
            <td><button className = "fa fa-save" style={{ backgroundColor: "red", color: "white", width: '400px' }} onClick={() => onSave(voucherData, totalDrAmt, totalCrAmt)}>Save Sales Invoice and Voucher</button></td>
            <td><button className = "fa fa-plus" style={{ backgroundColor: "cyan", color: "black", width: '230px' }} onClick={() => onAddVoucher()}>Add Voucher Item</button></td>
