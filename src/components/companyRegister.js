    ...
    //  };
      ...
      return (
        ...
        <form style={mystyle} onSubmit={this.handleSubmit}>
          ...
          Company ID :
          <input onInput={toInputLowercase} type="text" style={{marginLeft: "80px"}}
          ...
          <input type="text" style={{marginLeft: "45px"}}
