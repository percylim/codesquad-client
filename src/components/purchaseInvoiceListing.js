...
const csvReport = {
  ...
  const onLoadInvoice = async () => {
    // Axios loadSalesInvoice
        ...
        Axios
        .get(url + `/api/loadPurchaseInvoice`,
          {
            params: {
              companyID: companyID,
              startDate: txnDate,
  ...
  return (
    ...
    <div>
      ...
      <a style={{  marginRight: '.8rem' }} >Load Purchase Invoice From Date : </a>
        ...
        <button
         ...
         <button
            style={ {padding: '6px'} }
            type='button'
            className='btn btn-warning fa fa-file float-right'
      ...
      <div className="select-container" >
        ...
        <td><button style={{ backgroundColor: "green", color: "white", width: '80px', marginLeft: '10rem' }} onClick={() => handleHome()}>
        Home 
         <i className="fa fa-home" style={{ marginRight: '8px', border: '2px solid black',backgroundColor: 'yellow', color: 'black'}}></i>
        </button></td>
        <td><button style={{ backgroundColor: "blue", color: "white", width: '150px', marginLeft: '10rem' }} onClick={() => handleNew()}>
        New Listing 
         <i className="fa fa-book" style={{ marginRight: '8px', border: '2px solid black',backgroundColor: 'yellow', color: 'black'}}></i>
        </button></td>
        <td></td><td></td>
